 ...
 */
public class PIold implements Controller{
    private Number k;
    private Number Ti;
    private Number dt;
    private Value sum;
    ...
    public PIold(Class c, Number Ti, Number dt) throws InstantiationException, IllegalAccessException {
        this.Ti = Ti;
        this.dt = dt;
        initValues(c);
    }
    public PIold(Class c, Number kd, Number dt, Number initSum) throws InstantiationException, IllegalAccessException {
        this.Ti = kd;
        this.dt = dt;
        initValues(c);
        this.sum.setValue(initSum);
    }
    public PIold(Class c) throws InstantiationException, IllegalAccessException {
        this.Ti = 0;
        initValues(c);
    }
