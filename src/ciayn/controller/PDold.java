 ...
 */
public class PDold implements Controller{
    private Number kd;
    private Number kp;
    private Number dt;
    ...
    public PDold(Class c, Number kd, Number kp) throws InstantiationException, IllegalAccessException {
        this.kd = kd;
        this.kp= kp;
        initValues(c);
    }
    public PDold(Class c, Number kd, Number kp, Number dt) throws InstantiationException, IllegalAccessException {
        this.kd = kd;
        this.kp = kp;
        this.dt = dt;
        initValues(c);
